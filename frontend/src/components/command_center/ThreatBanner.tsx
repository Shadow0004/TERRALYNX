...
import { Wind, CloudRain, Waves, Clock, Compass, Activity, Zap, Radio } from 'lucide-react';
...
export const ThreatBanner: React.FC<ThreatBannerProps> = ({ hazard }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#18111e] via-[#141b2c] to-[#0f172a] border border-[#263553] rounded-xl p-4 shadow-lg mb-4 relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 relative z-10">
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            <div className="flex items-center space-x-2">
              ...
              >
                {isCyclone
                  ? `ACTIVE CYCLONE (CAT-${hazard.category})`
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          {/* Landfall ETA / Inundation Watch */}
          <div className="bg-[#0f1422]/80 border border-[#212b40] rounded-lg px-3 py-2">
            <div className="flex items-center space-x-1.5 text-slate-400 text-[11px]">
              <Clock className="w-3.5 h-3.5 text-amber-400 animate-spin" />
              <span>{isCyclone ? 'Est. Coastal Landfall' : 'Inundation Status'}</span>
            </div>
            <div className="mt-1 font-mono">
              {isCyclone && hazard.landfall_eta_hours ? (
                ...
                <>
                  <span className="text-base font-bold text-emerald-300">
                    {hazard.rainfall_rate_mm_hr > 5 ? 'Active Heavy Rain' : 'Active Live'}
                  </span>
